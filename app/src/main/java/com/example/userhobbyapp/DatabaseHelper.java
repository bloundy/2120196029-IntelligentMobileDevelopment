...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static String DATABASE_NAME = "userhobby_database";
    ...
    public ArrayList<UserModel> getAllUsers() {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                //SQLiteDatabase db hobby = this.getReadableDatabase();
                @SuppressLint("Recycle") Cursor cHobby = db.rawQuery(selectHobbyQuery, null);
